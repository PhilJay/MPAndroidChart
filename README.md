...
This repository's issue tracker is only for bugs and feature requests. The maintainers ask that you should refrain from asking questions about how to use MPAndroidChart through the issue tracker.
