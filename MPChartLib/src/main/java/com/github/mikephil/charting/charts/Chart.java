...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends
	...
	private final float DEFAULT_DRAG_COEF = 0.9F;
	private final float DEFAULT_OFFSET = 0.F;
	 ...
	 */
	private float mDragDecelerationFrictionCoef = DEFAULT_DRAG_COEF;
	 ...
	 */
	private float mExtraTopOffset = DEFAULT_OFFSET,
			mExtraRightOffset = DEFAULT_OFFSET,
			mExtraBottomOffset = DEFAULT_OFFSET,
			mExtraLeftOffset = DEFAULT_OFFSET;
